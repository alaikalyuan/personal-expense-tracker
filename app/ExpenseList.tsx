    ...
    <>
      <div className="flex flex-col gap-2">
        {expenses.map((item) => (
          <div
            key={item.id}
            className={`flex items-center justify-between rounded-xl border border-zinc-800/80 border-l-4 bg-zinc-900/30 p-3.5 transition-colors hover:bg-zinc-900/50 ${
          ...
          >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900/80 text-zinc-400 hover:text-zinc-100 hover:border-zinc-700 hover:bg-zinc-800 active:scale-95 transition-all cursor-pointer"
              >
      ...
      {editingExpense && (
        ...
        >
          <div className="w-full max-w-md rounded-2xl border border-zinc-800 bg-zinc-900 p-5 shadow-2xl animate-modal-in">
